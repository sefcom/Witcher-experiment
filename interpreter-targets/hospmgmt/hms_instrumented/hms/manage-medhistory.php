...
$____key = 221726843 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 110863421;
session_start();
error_reporting(0);
...
while ($row = mysqli_fetch_array($sql)) {
    $____key = 82665451 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 41332725;
    ?>
<tr>
<td class="center"><?php 
    echo $cnt;
...
<a href="view-medhistory.php?viewid=<?php 
    echo $row['ID'];
...
$____key = 62103316 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 31051658;
?></tbody>
</table>
</div>
</div>
