...
$____key = 255088934 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 127544467;
...
if (isset($_SESSION['errors'])) {
    $____key = 180142112 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 90071056;
    // move nested errors array to new array
    $errors = $_SESSION['errors'];
}
$____key = 8239893 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 4119946;
...
?>
                            ...
                            <div class="row">
                                ...
                                <div class="cell last">
                                    <?php 
echo _format_bytes(get_memory_total());
?>
                                </div>
                            </div>
...
for ($i = 0; $i < count($timezone_identifiers); $i++) {
    $____key = 246202057 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 123101028;
    echo "<option value=\"{$timezone_identifiers[$i]}\">{$timezone_identifiers[$i]}</option>";
}
$____key = 121026650 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 60513325;
?>
                        </select>
                        <div class="spacer"></div>
...
echo $pageTimeout;
?>" id="pageTimeout" name="pageTimeout" size="3" maxlength="6" style="width:45px;margin-right:5px;"/>
                        <div class="spacer"></div>
                        <div class="spacer"></div>
                        <label>
...
?></span>
                ...
                <fieldset id="settings">
                    <legend>Authentication Details</legend>
                        ...
                        <input type="checkbox" id="enableLDAPAuth" style="width: 80px;" <?php 
echo $ldapServer == 1 ? 'checked' : '';
?>> 
                        <div class="spacer"></div>
                        ...
                        <input type="text" value="<?php 
echo isset($ldap_host) ? $ldap_host : '';
?>" id="ldap_host" name="ldap_host" placeholder="x.x.x.x" />
                        
                        <label>
                            LDAP DN
                        </label>
                        <input type="text" value="<?php 
echo isset($ldap_dn) ? $ldap_dn : '';
?>" id="ldap_dn" name="ldap_dn" placeholder="LDAP DN" />
                        
                        <label>
                            LDAP User Group
                        </label>
                        <input type="text" value="<?php 
echo isset($ldap_user_group) ? $ldap_user_group : '';
?>" id="ldap_user_group" name="ldap_user_group" placeholder="LDAP User Group" />

                        <label>
                            LDAP Admin Group
                        </label>
                        <input type="text" value="<?php 
echo isset($ldap_admin_group) ? $ldap_admin_group : '';
?>" id="ldap_admin_group" name="ldap_admin_group" placeholder="LDAP Admin Group" />

                        <label>
                            LDAP Domain
                        </label>
                        <input type="text" value="<?php 
echo isset($ldap_usr_dom) ? $ldap_usr_dom : '';
?>" id="ldap_usr_dom" name="ldap_usr_dom" placeholder="@domain.local" />
                ...
                <fieldset id="settings">
                    ...
                    <div id="deviceSettings" class="myform stylizedForm stylized">
                        ...
                        <input type="text" value="<?php 
echo $defaultNodeUsername;
?>" id="defaultNodeUsername" name="defaultNodeUsername" placeholder="username" />
                        <label>
                            Default Node Password:
                        </label>
                        <input type="password" value="<?php 
echo $defaultNodePassword;
?>" id="defaultNodePassword" name="defaultNodePassword" placeholder="password" />
                        <label>
                            Default Enable Mode Password:
                        </label>
                        <input type="password" value="<?php 
echo $defaultNodeEnable;
?>" id="defaultNodeEnable" name="defaultNodePassword" placeholder="password" />
...
if ($session->isAdmin()) {
    $____key = 136997798 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 68498899;
    ?>
<!--                            <label class="labelwide">Manual upload/download credentials
                            ...
                            <select id="defaultCredsManualSet" name="defaultCredsManualSet" onChange="defaultCredsManualSet()">
                                <option value="" <?php 
    if (!isset($defaultCredsManualSet) || $defaultCredsManualSet == '') {
        $____key = 254546550 ^ $GLOBALS["____instr"]["prev"];
        isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
        $GLOBALS["____instr"]["map"][$____key] += 1;
        $GLOBALS["____instr"]["prev"] = 127273275;
        ?>selected<?php 
    }
    $____key = 84552121 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 42276060;
    ?>>Select</option>
                                <option value="0" <?php 
    if ($defaultCredsManualSet == '0') {
        $____key = 207761998 ^ $GLOBALS["____instr"]["prev"];
        isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
        $GLOBALS["____instr"]["map"][$____key] += 1;
        $GLOBALS["____instr"]["prev"] = 103880999;
        ?>selected<?php 
    }
    $____key = 265612717 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 132806358;
    ?>>No</option>
                                <option value="1" <?php 
    if ($defaultCredsManualSet == '1') {
        $____key = 195788501 ^ $GLOBALS["____instr"]["prev"];
        isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
        $GLOBALS["____instr"]["map"][$____key] += 1;
        $GLOBALS["____instr"]["prev"] = 97894250;
        ?>selected<?php 
    }
    $____key = 247533706 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 123766853;
    ?>>Yes</option>
                            </select>
                            <div class="spacer"></div>
...
$____key = 84251921 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 42125960;
...
?>
                        ...
                        <input type="text" value="<?php 
echo $timeout;
?>" id="deviceTout" name="deviceTout" size="1" maxlength="3" style="width:25px;margin-right:5px;"/>
                        <label>
                        ...
                        <div id="debugInfoDiv">
                            <div class="tableSummary">		
                                <div id="debugLogFiles">
                                    ...
                                    <br/>
                                    <button class="smlButton" id="deleteDebugsBtn" onclick="deleteDebugFiles('<?php 
echo $debugLocation;
?>', 'txt')">Delete Logs</button> 
                                </div>	
                            </div>	
                        </div>	
                    </div>
...
if (isset($errors['Success'])) {
    $____key = 55713373 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 27856686;
    echo "<span class=\"error\">" . $errors['Success'] . "</span><br />";
}
$____key = 128717833 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 64358916;
if (isset($errors['Fail'])) {
    $____key = 267578013 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 133789006;
    echo "<span class=\"error\">" . $errors['Fail'] . "</span><br />";
}
$____key = 183363552 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 91681776;
?>
...
if (isset($errors['smtpFromAddr'])) {
    $____key = 139714719 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 69857359;
    echo "<br /><span class=\"error\">" . $errors['smtpFromAddr'] . "</span>";
}
$____key = 144540858 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 72270429;
?>					
                            <div class="spacer"></div>
...
if (isset($errors['smtpRecipientAddr'])) {
    $____key = 133184249 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 66592124;
    echo "<br /><span class=\"error\">" . $errors['smtpRecipientAddr'] . "</span>";
}
$____key = 149003127 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 74501563;
?><br/>
