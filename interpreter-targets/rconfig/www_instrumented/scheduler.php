...
$____key = 228318322 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 114159161;
...
if (isset($_SESSION['errors'])) {
    $____key = 236621339 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 118310669;
    // move nest errors array to new array
    $errors = $_SESSION['errors'];
}
$____key = 129723264 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 64861632;
...
if (isset($errors['Success'])) {
    $____key = 135976041 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 67988020;
    echo "<span class=\"error\">" . $errors['Success'] . "</span><br/>";
}
$____key = 23120296 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 11560148;
?> 
                    <?php 
if (isset($errors['Fail'])) {
    $____key = 199972761 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 99986380;
    echo "<span class=\"error\">" . $errors['Fail'] . "</span><br/>";
}
$____key = 11570912 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 5785456;
?> 
                    <?php 
if (isset($errors['hostfolder'])) {
    $____key = 19146346 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 9573173;
    echo "<span class=\"error\">" . $errors['hostfolder'] . "</span><br/>";
}
$____key = 206039136 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 103019568;
?> 
                    <?php 
if (isset($errors['fileCreateError'])) {
    $____key = 279179 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 139589;
    echo "<span class=\"error\">" . $errors['fileCreateError'] . "</span><br/>";
}
$____key = 52805994 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 26402997;
?>
                    <?php 
if (isset($errors['crontab'])) {
    $____key = 155622310 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 77811155;
    echo "<span class=\"error\">" . $errors['crontab'] . "</span><br/>";
}
$____key = 70177596 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 35088798;
?>
                    <div id="toolbar">
...
if (isset($errors['taskType'])) {
    $____key = 158762786 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 79381393;
    echo "<span class=\"error\">" . $errors['taskType'] . "</span>";
}
$____key = 30101569 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 15050784;
?>
                            </label>
                            <?php 
...
?>
                            ...
                            <div name="reportTypeSlctDiv" id ="reportTypeSlctDiv">
                                ...
                                <select name="reportTypeSlct[]" id="reportTypeSlct">
                                    ...
                                    <?php 
echo reportsOptions();
// output full report name list options from scheduler.frm.func.php
?>
                                </select>
                            </div>
...
if (isset($errors['snippetSlct'])) {
    $____key = 27996267 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 13998133;
    echo "<span class=\"error\">" . $errors['snippetSlct'] . "</span><br/>";
}
$____key = 83958611 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 41979305;
?>
                                </label>
                                <select name="snippetSlct" id="snippetSlct">
                                    <option value="select">Select</option>
                                    <?php 
echo snippetsOptions();
// output full report name list options from scheduler.frm.func.php
?>
                                </select>
                            </div>
...
if (isset($errors['taskName'])) {
    $____key = 214157552 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 107078776;
    echo "<span class=\"error\">" . $errors['taskName'] . "</span><br/>";
}
$____key = 220747072 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 110373536;
?>
                            </label>
...
if (isset($errors['taskDesc'])) {
    $____key = 266739513 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 133369756;
    echo "<span class=\"error\">" . $errors['taskDesc'] . "</span>";
}
$____key = 201919674 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 100959837;
?>
                            </label>
...
if (isset($errors['catId'])) {
    $____key = 256670678 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 128335339;
    echo "<span class=\"error\">" . $errors['catId'] . "</span>";
}
$____key = 187147921 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 93573960;
?>
                                </label>
...
if (isset($errors['catCommand'])) {
    $____key = 38589250 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 19294625;
    echo "<span class=\"error\">" . $errors['catCommand'] . "</span>";
}
$____key = 239193476 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 119596738;
?>
                                </label>
...
if (isset($errors['selectRadio'])) {
    $____key = 20826301 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 10413150;
    echo "<span class=\"error\">" . $errors['selectRadio'] . "</span>";
}
$____key = 159066075 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 79533037;
if (isset($errors['deviceSelectRadio'])) {
    $____key = 178085886 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 89042943;
    echo "<span class=\"error\">" . $errors['deviceSelectRadio'] . "</span>";
}
$____key = 123033755 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 61516877;
?>
                                </label>
                                ...
                                <select name="deviceSelect[]" id ="deviceSelect" size="10" multiple disabled>
                                    <?php 
foreach ($devQ as $row) {
    $____key = 155616512 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 77808256;
    echo "<option value=" . $row['id'] . "> " . $row['deviceName'] . "</option> ";
}
$____key = 199156101 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 99578050;
?>
                                </select>
                            </div>
                            <div class="spacer">
...
if (isset($errors['catSelectRadio'])) {
    $____key = 61406395 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 30703197;
    echo "<span class=\"error\">" . $errors['catSelectRadio'] . "</span>";
}
$____key = 245867875 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 122933937;
?>
                                </label>
                                ...
                                <select name="catSelect[]" id ="catSelect" size="10" multiple disabled>
                                    <?php 
foreach ($catQ as $row) {
    $____key = 243308950 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 121654475;
    echo "<option value=" . $row['id'] . ">" . $row['categoryName'] . "</option>";
}
$____key = 32555070 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 16277535;
?>
                                </select>
                            </div>
                            <div class="spacer">
...
if (isset($errors['cron'])) {
    $____key = 116407775 ^ $GLOBALS["____instr"]["prev"];
    isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
    $GLOBALS["____instr"]["map"][$____key] += 1;
    $GLOBALS["____instr"]["prev"] = 58203887;
    echo "<span class=\"error\">" . $errors['cron'] . "</span><br/>";
}
$____key = 21762448 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 10881224;
?>
                                <div class="spacer">
                                </div>
