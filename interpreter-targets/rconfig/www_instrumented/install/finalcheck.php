...
$____key = 3815104 ^ $GLOBALS["____instr"]["prev"];
isset($GLOBALS["____instr"]["map"][$____key]) ?: ($GLOBALS["____instr"]["map"][$____key] = 0);
$GLOBALS["____instr"]["map"][$____key] += 1;
$GLOBALS["____instr"]["prev"] = 1907552;
    ...
    <div id="section">
        ...
        <div id="items">
            ...
            <div id="passDiv" class="cell">
                ...
                <div class="clear"></div>	
                <br/>
                Please go to the <a href="<?php 
echo 'https://' . $_SERVER['SERVER_NAME'] . '/login.php';
?>">login page</a> to launch rConfig
            </div>
