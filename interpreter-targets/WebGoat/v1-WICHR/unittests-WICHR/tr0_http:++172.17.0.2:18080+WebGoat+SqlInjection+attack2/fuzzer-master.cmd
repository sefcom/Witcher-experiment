/afl/afl-fuzz -i /tmp/output/initial_seeds -o /tmp/output -m 8G -M fuzzer-master -x /tmp/output/dict.txt -t 5000+ -- /httpreqr --url http://172.17.0.2:18080/WebGoat/SqlInjection/attack2
...
LOGIN_COOKIE=JSESSIONID=RZkHOjDu3udXNLvLlfo3_loGtDzw9XeO1WOj7Cxu; path=/WebGoat
LOGNAME=wc
...
PORT=18080
PS1=\[[38;5;213m\]\u@\h-2 [witcher] \[[38;5;69m\]\w \[\e[1;31m\](1)\[\e[0m\] 
PWD=/p/Witcher/base/httpreqr
SCRIPT_FILENAME=http://172.17.0.2:18080/WebGoat/SqlInjection/attack2
SERVER_NAME=witcher
SHELL=/bin/bash
SHLVL=1
STRICT=3
