...
LOGIN_COOKIE=OpenEMR=gavnkaoq8i5cm4bkeqrc2vl55c; path=/openemr
...
SCRIPT_FILENAME=/var/www/openemr/interface/language/language.php
SCRIPT_NAME=/var/www/openemr/interface/language/language.php
SERVER_NAME=witcher
SHLVL=1
STRICT=3
TERM=xterm-256color
