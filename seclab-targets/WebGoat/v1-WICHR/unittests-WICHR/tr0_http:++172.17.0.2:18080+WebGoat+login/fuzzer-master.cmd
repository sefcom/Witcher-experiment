/afl/afl-fuzz -i /tmp/output/initial_seeds -o /tmp/output -m 8G -M fuzzer-master -x /tmp/output/dict.txt -t 5000+ -- /httpreqr --url http://172.17.0.2:18080/WebGoat/login
...
LOGIN_COOKIE=JSESSIONID=0gHhPZM7lSltCKNubWmvt-oL5wtun85ZAo5AKm5U; path=/WebGoat
LOGNAME=wc
...
SCRIPT_FILENAME=http://172.17.0.2:18080/WebGoat/login
SCRIPT_NAME=http://172.17.0.2:18080/WebGoat/login
SERVER_NAME=witcher
SHELL=/bin/bash
SHLVL=1
STRICT=3
