/afl/afl-fuzz -i ./EXWICHR/work/initial_seeds -o ./EXWICHR/work -m 8G -M fuzzer-master -x ./EXWICHR/work/dict.txt -t 5000+ -- /usr/local/bin/php-cgi ''

AFL_BASE=./EXWICHR/work/fuzzer-master
AFL_HTTP_DICT=1
AFL_PATH=/afl
...
DOCUMENT_ROOT=/app
HOME=/home/wc
HOSTNAME=d33938148ad9
LAST_IP=27
LD_LIBRARY_PATH=/wclibs
LESSCLOSE=/usr/bin/lesspipe %s %s
LESSOPEN=| /usr/bin/lesspipe %s
LOGIN_COOKIE=PHPSESSID=mug1lp22gc2sognqh90p10gjqr; path=/
...
PWD=/p/Witcher/seclab-targets/cve-2020-25487/witcher
SCRIPT_FILENAME=/app/zms/admin/add-foreigners-ticket.php
SCRIPT_NAME=/app/zms/admin/add-foreigners-ticket.php
SERVER_NAME=witcher
SHLVL=1
STRICT=3
TERM=xterm-256color
